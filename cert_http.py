...
def _make_mobileconfig_cert_only() -> bytes:
    """
    Install CA cert only — no proxy auto-config.
    ASCII-only XML to avoid iOS plist parse errors.
    """
    cert_data = _cert_b64()
    xml = (
        ...
        '\t\t\t<key>PayloadUUID</key>\n'
        f'\t\t\t<string>{_CERT_UUID}</string>\n'
        '\t\t\t<key>PayloadDisplayName</key>\n'
        '\t\t\t<string>mitmproxy CA</string>\n'
        '\t\t\t<key>PayloadContent</key>\n'
        f'\t\t\t<data>{cert_data}</data>\n'
        '\t\t</dict>\n'
        '\t</array>\n'
        '</dict>\n'
        '</plist>'
