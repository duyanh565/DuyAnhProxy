...
def _make_mobileconfig_cert_only() -> bytes:
    """
    Chỉ cài CA cert — fix lỗi 'Không thể truy xuất cấu hình phiên bản'.
    Không cấu hình proxy tự động (user nhập IP/port thủ công trong WiFi settings).
    """
    cert_data = _cert_b64()
...
<dict>
  ...
  <string>mitmproxy CA Cert</string>
  <key>PayloadDescription</key>
  <string>Fix lỗi SSL khi dùng proxy mitmproxy.</string>
  <key>PayloadIdentifier</key>
  <string>com.mitmproxy.cert.only</string>
